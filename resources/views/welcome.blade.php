...
@section('content')
			...
			<div class="row">
				<div class="col-md-3" >
					<div class="services-inner-box">
						<h2>
							...
							<img src="uploads/undraw/team.png" alt="">
				...
				<div class="col-md-3" >
					<div class="services-inner-box">
						<h2>
							<div class="text-center">
							<img src="uploads/undraw/browse.png" alt="">
							</div>
				...
				<div class="col-md-3" >
					<div class="services-inner-box">
						<h2>
							<div class="text-center">
							<img src="uploads/undraw/plan.png" alt="">
					...
					<div class="services-inner-box">
						<h2>
							<div class="text-center">
							<img src="uploads/undraw/destination.png" alt="">
	...
	<div id="catalog" class="section wb">
		...
		<div class="row justify-content-end">
			...
			<div class="col-md-6"  style="overflow:hidden; height:350px">
        ...
        <li class="font-weight-bold">Цаасны төрөл:</li>
            ...
            <div class="col-md-6">
                <img style="width:100%" src="{{asset('uploads/undraw/book.png')}}" alt="">
            </div>
            <div class="col-md-12">
            ...
            <div class="col-md-6">
                <img style="width:100%" src="{{asset('uploads/undraw/magazine-1.png')}}" alt="">
            </div>
            <div class="col-md-12">
